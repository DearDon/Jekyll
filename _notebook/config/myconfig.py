...
# File Name: jekyll.py
# Purpose:
#	This file is to self configure jupyter nbconvert
# History:
...
c.MarkdownExporter.template_path = ['/home/don/Blog/_notebook/config'] # point this to your jekyll template file
...
# c.FilesWriter.build_directory = os.pathsep.join([blog_path, _notebook/config]) # point this to your build directory
...
def path2support(path):
    ...
    # return '{{ BASE_PATH }}/assets/' + os.path.basename(path)
    return os.path.join('/assets', c.NbConvertApp.output_base+'_files', os.path.basename(path))
